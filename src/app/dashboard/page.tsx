      ...
      <Card className="p-5">
        ...
        <div className="flex flex-wrap items-end gap-4">
          <label className="text-sm">
            ...
            <input className="w-full sm:w-56 rounded-md border border-slate-300 px-3 py-2" value={name} onChange={(e) => setName(e.target.value)} />
          </label>
          <label className="text-sm">
        ...
        {(empCount ?? 0) === 0 && !loading && (
          <p className="mt-3 text-sm text-amber-700">No employees yet — add some on the Employees page before generating.</p>
        )}
      </Card>
